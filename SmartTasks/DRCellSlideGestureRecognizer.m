...
- (void)handlePan {
	if (self.state == UIGestureRecognizerStateBegan) {
        ...
        self.actionView.frame = CGRectMake(self.cell.frame.origin.x, self.cell.frame.origin.y + taskCellSpacingBetweenComponents, self.cell.frame.size.width, self.cell.frame.size.height - taskCellSpacingBetweenComponents);
